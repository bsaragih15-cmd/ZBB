...
export function BoardPack({ fleet, cap = 0.5, benchMode = 'absolute', decisions = [] }:
  { fleet: Fleet; cap?: number; benchMode?: BenchmarkMode; decisions?: Decision[] }) {
  ...
  return (
    <div className="board-wrap">
      <div className="no-print board-actions">
        ...
        <span className="board-hint">Opens your browser print dialog — choose “Save as PDF”. Reflects the current benchmark mode and {pct}% ambition.</span>
      </div>
      ...
      <div className="board">
        <header className="bd-head">
          ...
          <div className="bd-meta">
            ...
            <div>{today}</div>
            <div>{benchMode === 'normalized' ? 'Like-for-like (size-normalized)' : 'Absolute'} benchmark · {pct}% ambition</div>
        ...
        <h1 className="bd-h1">
          ...
          Closing {pct}% of the gap frees <b>Rp {rpBn(head.tot)} Bn</b>; the full gap is Rp {rpBn(full.tot)} Bn.
        </h1>
        ...
        <section className="bd-kpis">
          ...
          <div className="bd-kpi"><div className="k">Value at stake ({pct}%)</div><div className="v">Rp {rpBn(head.tot)} Bn</div></div>
